 ...
 using namespace std;
  ...
  int main() 
  {
      ...
      double A, B;
      cin >> fixed >> setprecision(1); //1 digito apos o ponto decimal
      cin >> A >> B; //leia 2 valores flutuantes
      double media;
      cout << fixed << setprecision(5);//5 digito apos o ponto decimal
  ...
  //exemplo abaixo, com 5 dígitos após o ponto decimal
  //e com um espaço em branco antes e depois da igualdade.
  //Utilize variáveis de dupla precisão (double) e como todos
  //os problemas. 