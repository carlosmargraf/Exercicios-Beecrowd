...
//Isto faz parte da Competição Ideal de Consumidores de Chá Puro 
//(da sigla em inglês ICPC), que um programa de TV local está organizando. 
//Durante o show, um bule de chá completo é preparado e são entregues uma xícara 
//de chá para cada um dos cinco competidores. Os participantes devem cheirar, saborear 
//e avaliar a amostra, de modo a identificar o tipo de chá, que pode ser: 
