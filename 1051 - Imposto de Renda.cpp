...
{
    double renda, resultado, calculo1, calculo2, calculo3;
    cin >> setprecision(2);
    cin >> renda;
    ...
    else
    {
        ...
        {
            calculo1 = renda - 2000.00;
            calculo1 = ((calculo1*8)/100);
            resultado = calculo1;
        }
        else if(renda >= 3000.01 && renda <= 4500.00)
        {
            calculo1 = renda - 2000.00;
            calculo2 = calculo1 - 1000.00;
            calculo1 -= calculo2;
            calculo1 = ((calculo1*8)/100);
            calculo2 = ((calculo2*18)/100);
        ...
        else
        {
            calculo1 = renda - 2000.00;
            calculo2 = calculo1 - 1000.00;
            calculo3 = calculo2 - 1500.00;
            calculo1 -= calculo2;
            calculo2 -= calculo3;
            calculo1 = ((calculo1*8)/100);
            calculo2 = ((calculo2*18)/100);
            calculo3 = ((calculo3*28)/100);
            resultado = calculo3 + calculo2 + calculo1;
        }
        cout << fixed << setprecision(2);
        cout << "R$ " << setprecision(2) << resultado << endl;
    }
    return 0;
}
